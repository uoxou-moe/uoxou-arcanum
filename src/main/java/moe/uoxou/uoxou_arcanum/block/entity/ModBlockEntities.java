...
public final class ModBlockEntities {
	...
	public static final BlockEntityType<PotionCauldronBlockEntity> POTION_CAULDRON = BlockEntityType.Builder.create(PotionCauldronBlockEntity::new, ModBlocks.POTION_CAULDRON).build(null);
